...
@section('content')
<div class="container">
<div class="alert alert-danger">まだキャンセルされていません。下のフォームから送信してください</div>
	<h1>申請キャンセル</h1>
{{--
	<div class="row">
		<div class="col-sm-12">
...
<hr />
	...
	@if ($appointment->status_id == \App\Appointment::STATUS_ID_REQUEST)
		...
		<form method="post" action="{{$apl_code_uri}}/appointmentcancel/{{$appointment->id}}">
			{!! method_field('put') !!}
			<div class="form-group">
				<label>一言 キャンセル理由</label>
